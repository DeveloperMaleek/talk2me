...
class WordsOfAffirmationThree extends StatefulWidget {
  const WordsOfAffirmationThree({Key? key}) : super(key: key);

  @override
  State<WordsOfAffirmationThree> createState() =>
      _WordsOfAffirmationThreeState();
}

class _WordsOfAffirmationThreeState extends State<WordsOfAffirmationThree> {
        ...
        child: Column(
          ...
          children: [
            Align(
              ...
              child: SvgPicture.asset("assets/images/anger.svg",
            ...
            Column(
              ...
              children: [
                ...
                const SubtitleOne(
                    text:
                        'I am going to not let the insignificant things get to me again.',
                    textColor: AppColors.textColorLightBg),
                Visibility(
