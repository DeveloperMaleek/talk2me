...
class AppColors {
  AppColors._(); // this ensures you can instantiate this class

//ColorScheme for app
  static const Color primaryColor = Color(0xFF11CDD6);
  static const Color primaryColor75 = Color(0xFFB0ECB8);
  static const Color primaryColor50 = Color(0xFFCBF3D0);
  static const Color primaryColor25 = Color(0xFFE5F9E7);
  static const Color lightBackground = Color(0xFFFFFFFF);
  static const Color greenBackground = Color(0xFFE9FEFF);
  ...
  static const Color textColorPrimary = Color(0xFF101010);
  static const Color textColorLightBg = Color(0xFF273946);
  static const Color textColorDarkBg = Color(0xFFF2F3F8);
  static const Color subtitleTextLightBg = Color(0xFF828282);
